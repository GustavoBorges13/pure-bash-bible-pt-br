...
* [PREFÁCIO](#prefácio)
* [STRINGS](#strings)
    * [Remover espaços em branco do início e fim da string](#remover-espaços-em-branco-do-início-e-fim-da-string)
    * [Remover todos os espaços em branco da string e truncar espaços](#remover-todos-os-espaços-em-branco-da-string-e-truncar-espaços)
    * [Usar regex em uma string](#usar-regex-em-uma-string)
    * [Dividir uma string em um delimitador](#dividir-uma-string-em-um-delimitador)
    * [Alterar uma string para minúsculas](#alterar-uma-string-para-minúsculas)
    * [Alterar uma string para maiúsculas](#alterar-uma-string-para-maiúsculas)
    * [Inverter a caixa de uma string](#inverter-a-caixa-de-uma-string)
    * [Remover aspas de uma string](#remover-aspas-de-uma-string)
    * [Remover todas as instâncias de um padrão da string](#remover-todas-as-instâncias-de-um-padrão-da-string)
    * [Remover a primeira ocorrência de um padrão da string](#remover-a-primeira-ocorrência-de-um-padrão-da-string)
    * [Remover padrão do início da string](#remover-padrão-do-início-da-string)
    * [Remover padrão do final da string](#remover-padrão-do-final-da-string)
    * [Codificar uma string em percent-encode (URL)](#codificar-uma-string-em-percent-encode-url)
    * [Decodificar uma string percent-encoded](#decodificar-uma-string-percent-encoded)
    * [Verificar se a string contém uma substring](#verificar-se-a-string-contém-uma-substring)
    * [Verificar se a string começa com uma substring](#verificar-se-a-string-começa-com-uma-substring)
    * [Verificar se a string termina com uma substring](#verificar-se-a-string-termina-com-uma-substring)
* [ARRAYS](#arrays)
    * [Inverter um array](#inverter-um-array)
    * [Remover elementos duplicados do array](#remover-elementos-duplicados-do-array)
    * [Elemento aleatório do array](#elemento-aleatório-do-array)
    * [Ciclar através de um array](#ciclar-através-de-um-array)
    * [Alternar entre dois valores](#alternar-entre-dois-valores)
* [LOOPS (LAÇOS)](#loops-laços)
    * [Loop sobre um intervalo de números](#loop-sobre-um-intervalo-de-números)
    * [Loop sobre um intervalo variável de números](#loop-sobre-um-intervalo-variável-de-números)
    * [Loop sobre um array](#loop-sobre-um-array)
    * [Loop sobre um array com índice](#loop-sobre-um-array-com-um-índice)
    * [Loop sobre o conteúdo de um arquivo](#loop-sobre-o-conteúdo-de-um-arquivo)
    * [Loop sobre arquivos e diretórios](#loop-sobre-arquivos-e-diretórios)
* [MANIPULAÇÃO DE ARQUIVOS](#manipulação-de-arquivos)
    * [Ler um arquivo para uma string](#ler-um-arquivo-para-uma-string)
    * [Ler um arquivo para um array (*por linha*)](#ler-um-arquivo-para-um-array-por-linha)
    * [Obter as primeiras N linhas de um arquivo](#obter-as-primeiras-n-linhas-de-um-arquivo)
    * [Obter as últimas N linhas de um arquivo](#obter-as-últimas-n-linhas-de-um-arquivo)
    * [Obter o número de linhas em um arquivo](#obter-o-número-de-linhas-em-um-arquivo)
    * [Contar arquivos ou diretórios em um diretório](#contar-arquivos-ou-diretórios-em-um-diretório)
    * [Criar um arquivo vazio](#criar-um-arquivo-vazio)
    * [Extrair linhas entre dois marcadores](#extrair-linhas-entre-dois-marcadores)
* [CAMINHOS DE ARQUIVO](#caminhos-de-arquivo)
    * [Obter o nome do diretório de um caminho de arquivo](#obter-o-nome-do-diretório-de-um-caminho-de-arquivo)
    * [Obter o nome base de um caminho de arquivo](#obter-o-nome-base-de-um-caminho-de-arquivo)
* [VARIÁVEIS](#variáveis)
    * [Atribuir e acessar uma variável usando uma variável](#atribuir-e-acessar-uma-variável-usando-uma-variável)
    * [Nomear uma variável com base em outra variável](#nomear-uma-variável-com-base-em-outra-variável)
* [SEQUÊNCIAS DE ESCAPE](#sequências-de-escape)
    * [Cores de Texto](#cores-de-texto)
    * [Atributos de Texto](#atributos-de-texto)
    * [Movimento do Cursor](#movimento-do-cursor)
    * [Apagando Texto](#apagando-texto)
* [EXPANSÃO DE PARÂMETROS](#expansão-de-parâmetros)
    * [Indireção](#indireção)
    * [Substituição](#substituição)
    * [Comprimento](#comprimento)
    * [Expansão](#expansão)
    * [Modificação de Caixa (Maiúscula/Minúscula)](#modificação-de-caixa-maiúsculaminúscula)
    * [Valor Padrão](#valor-padrão)
* [EXPANSÃO DE CHAVES](#expansão-de-chaves)
    * [Intervalos](#intervalos)
    * [Listas de Strings](#listas-de-strings)
* [EXPRESSÕES CONDICIONAIS](#expressões-condicionais)
    * [Condicionais de Arquivo](#condicionais-de-arquivo)
    * [Comparações de Arquivo](#comparações-de-arquivo)
    * [Condicionais de Variável](#condicionais-de-variável)
    * [Comparações de Variável](#comparações-de-variável)
* [OPERADORES ARITMÉTICOS](#operadores-aritméticos)
    * [Atribuição](#atribuição)
    * [Aritmética](#aritmética)
    * [Bitwise (Bit a bit)](#bitwise-bit-a-bit)
    * [Lógico](#lógico)
    * [Diversos](#diversos)
* [ARITMÉTICA](#aritmética-1)
    * [Sintaxe mais simples para definir variáveis](#sintaxe-mais-simples-para-definir-variáveis)
    * [Testes Ternários](#testes-ternários)
* [TRAPS (ARMADILHAS)](#traps-armadilhas)
    * [Fazer algo ao sair do script](#fazer-algo-ao-sair-do-script)
    * [Ignorar interrupção do terminal (CTRL+C, SIGINT)](#ignorar-interrupção-do-terminal-ctrlc-sigint)
    * [Reagir ao redimensionamento da janela](#reagir-ao-redimensionamento-da-janela)
    * [Fazer algo antes de cada comando](#fazer-algo-antes-de-cada-comando)
    * [Fazer algo quando uma função shell ou arquivo carregado terminar de executar](#fazer-algo-quando-uma-função-shell-ou-arquivo-carregado-terminar-de-executar)
* [PERFORMANCE](#performance)
    * [Desativar Unicode](#desativar-unicode)
* [SINTAXE OBSOLETA](#sintaxe-obsoleta)
    * [Shebang](#shebang)
    * [Substituição de Comando](#substituição-de-comando)
    * [Declaração de Função](#declaração-de-função)
* [VARIÁVEIS INTERNAS](#variáveis-internas)
    * [Obter a localização do binário `bash`](#obter-a-localização-do-binário-bash)
    * [Obter a versão do processo `bash` atual em execução](#obter-a-versão-do-processo-bash-atual-em-execução)
    * [Abrir o editor de texto preferido do usuário](#abrir-o-editor-de-texto-preferido-do-usuário)
    * [Obter o nome da função atual](#obter-o-nome-da-função-atual)
    * [Obter o nome do host (hostname) do sistema](#obter-o-nome-do-host-hostname-do-sistema)
    * [Obter a arquitetura do Sistema Operacional](#obter-a-arquitetura-do-sistema-operacional)
    * [Obter o nome do Sistema Operacional / Kernel](#obter-o-nome-do-sistema-operacional--kernel)
    * [Obter o diretório de trabalho atual](#obter-o-diretório-de-trabalho-atual)
    * [Obter o número de segundos que o script está rodando](#obter-o-número-de-segundos-que-o-script-está-rodando)
    * [Obter um inteiro pseudoaleatório](#obter-um-inteiro-pseudoaleatório)
* [INFORMAÇÕES SOBRE O TERMINAL](#informações-sobre-o-terminal)
    * [Obter o tamanho do terminal em linhas e colunas (*de um script*)](#obter-o-tamanho-do-terminal-em-linhas-e-colunas-de-um-script)
    * [Obter o tamanho do terminal em pixels](#obter-o-tamanho-do-terminal-em-pixels)
    * [Obter a posição atual do cursor](#obter-a-posição-atual-do-cursor)
* [CONVERSÃO](#conversão)
    * [Converter uma cor hex para RGB](#converter-uma-cor-hex-para-rgb)
    * [Converter uma cor RGB para hex](#converter-uma-cor-rgb-para-hex)
* [CODE GOLF](#code-golf)
    * [Sintaxe de loop `for` mais curta](#sintaxe-de-loop-for-mais-curta)
    * [Loops infinitos mais curtos](#loops-infinitos-mais-curtos)
    * [Declaração de função mais curta](#declaração-de-função-mais-curta)
    * [Sintaxe `if` mais curta](#sintaxe-if-mais-curta)
    * [Declaração `case` mais simples para definir variável](#declaração-case-mais-simples-para-definir-variável)
* [OUTROS](#outros)
    * [Usar `read` como alternativa ao comando `sleep`](#usar-read-como-alternativa-ao-comando-sleep)
    * [Verificar se um programa está no PATH do usuário](#verificar-se-um-programa-está-no-path-do-usuário)
    * [Obter a data atual usando `strftime`](#obter-a-data-atual-usando-strftime)
    * [Obter o nome de usuário do usuário atual](#obter-o-nome-de-usuário-do-usuário-atual)
    * [Gerar um UUID V4](#gerar-um-uuid-v4)
    * [Barras de progresso](#barras-de-progresso)
    * [Obter a lista de funções em um script](#obter-a-lista-de-funções-em-um-script)
    * [Ignorar aliases do shell](#ignorar-aliases-do-shell)
    * [Ignorar funções do shell](#ignorar-funções-do-shell)
    * [Executar um comando em segundo plano (background)](#executar-um-comando-em-segundo-plano-background)
    * [Capturar o retorno de uma função sem substituição de comando](#capturar-o-retorno-de-uma-função-sem-substituição-de-comando)
* [POSFÁCIO](#posfácio)
